 ...
 */
package com.example.wrmapz.controller.filepicker;
...
import com.example.wrmapz.controller.filefilter.ValidFileFilter;
...
//	private File MAP_FILE;
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (selectedFile.isDirectory()) {
			...
			showToastOnUiThread("Browse Current directory");
...
//			showToastOnUiThread("Select "+String.valueOf(selectedFile.getAbsolutePath()));
			finish();
		} else {
			showDialog(DIALOG_FILE_INVALID);
			
			showToastOnUiThread("Invalid");
		}
	}
	...
	void showToastOnUiThread(final String text) {
		if (AndroidUtils.currentThreadIsUiThread()) {
			...
			runOnUiThread(new Runnable() {
				@Override
				public void run() {
					Toast toast = Toast.makeText(FilePicker.this, text,
							Toast.LENGTH_LONG);
					toast.show();
				}
			});
